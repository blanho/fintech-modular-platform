...
public class NotificationRepository : INotificationRepository
{
    ...
    public async Task<IReadOnlyList<Domain.Entities.Notification>> GetPendingAsync(int limit = 100, CancellationToken ct = default)
    {
    ...
    public async Task<IReadOnlyList<Domain.Entities.Notification>> GetFailedForRetryAsync(int maxRetries = 3, int limit = 100, CancellationToken ct = default)
    {
        return await _context.Notifications
